...
const kMyName = "Hung Luong Do Minh";
const kInformationData = <String, dynamic>{
  "hi": "Hi There! I'm ",
  "name": kMyName,
  "title":
      ...
      "ls": [
        {
          "n": "Android",
          "l":
              "https://play.google.com/store/apps/details?id=vn.homecredit.hcvn",
        },
        {
          "n": "iOS",
  ...
  "social": <Map<String, dynamic>>[
    ...
    },
    {
      ...
      "l": "https://pub.dev/publishers/romanticdeveloper.com/packages",
    },
    {
